            ...
            {isAuthenticated && (
              <>
                <button
                  ...
                  className="px-6 py-2 bg-green-500 hover:bg-green-700 cursor-pointer rounded-full text-white transition-all"
                >
                  Dashboard
                </button>
                ...
                <button
                  ...
                  className="px-6 py-2 border cursor-pointer rounded-full transition-all text-slate-700 hover:bg-slate-50"
                >
                  Logout
                </button>
              </>
